...
namespace NotesWebApp.Controllers
{
    public class NotesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NoteTitle,NoteInfo")] Note note)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NoteTitle,NoteInfo")] Note note)
        {
            if (id != note.Id)
            {
                return NotFound();
